...
> 学习Python知识，可以学习官方Python教程，<font color=#FF0000>[https://docs.python.org/3/](https://docs.python.org/3/)</font>，或是通用的Python教程书籍，比如：
>
...
集合打印，会出现集合成员乱序，与cpython的顺序不同，micropython和cpython排序算法不同所导致</font>
